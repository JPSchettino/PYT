    ...
    layout = html.Div([
        ...
        html.Div([
            ...
            html.Div([
                ...
                html.P('Perfil dos testers alcançados durante a campanha', className='header-subtitle')
            ...
            html.Div([
                ...
                html.Div([
                    html.Img(src='assets\sensorial3.png', className='header-icon'),  # Add icons
                    html.A('Análise Sensorial', href='/analise-sensorial', className='header-link')
                ], className='header-link-container')
        ...
        html.Div([
            html.Div([
                html.P('Qual pesquisa você quer visualizar', className='label'),
                dcc.Dropdown(
                    id='base_de_dados',
                    options=[
                        {'label': 'Biscoito Doce Recheado', 'value': 'Biscoito Doce Recheado'},
                        {'label': 'Wafer', 'value': 'Wafer'}
                    ],
                    value="Biscoito Doce Recheado",
        ...
        html.Div([
            ...
            html.Div([
                dcc.Graph(id='bar_chart3_', config={'displayModeBar': 'hover'}, style={'height': '550px'})
            ], className='chart-container six columns')
        ], className="row flex-display"),
        ...
        html.Div([
            html.Div([
                dcc.Graph(id='g_h_bar_chart2_', config={'displayModeBar': 'hover'}, style={'height': '850px'})
            ], className='chart-container six columns'),

                    
            html.Div([
                dcc.Graph(id='g_h_bar_chart3_', config={'displayModeBar': 'hover'}, style={'height': '850px'})
            ], className='chart-container six columns')
        ...
        html.Div([
            html.Div([
                dcc.Graph(id='donut_chart2', config={'displayModeBar': 'hover'}, style={'height': '550px'})
            ], className='chart-container four columns'),

            html.Div([
                dcc.Graph(id='h_bar_chart1_', config={'displayModeBar': 'hover'}, style={'height': '550px'})
            ], className='chart-container eight columns')
        ], className="row flex-display"),
        ...
        html.Div([
            html.Div([
                dcc.Graph(id='h_bar_chart2_', config={'displayModeBar': 'hover'}, style={'height': '550px'})
                   ...
                   html.Div([
                dcc.Graph(id='g_h_bar_chart4_', config={'displayModeBar': 'hover'}, style={'height': '550px'})
            ], className='chart-container six columns'),
                ...
                html.Div([
            html.Div([
                dcc.Graph(id='g_h_bar_chart1_', config={'displayModeBar': 'hover'}, style={'height': '750px'})
            ], className='chart-container tv columns'),
...
def sens_layout(faixa_etaria_options, se_declara_options, classe_eco_servicos_options,
                  reside_sp_options, tem_filhos_options, resposta_selecionada_options):
    ...
    layout = html.Div([
        ...
        # Header Section
        html.Div([
            html.Img(src='assets/Logo-Bauducco-Png-1024x1024.webp', className='header-logo'),  # Add the logo image
            html.Div([
                html.H1('Análise Sensorial', className='header-title'),
                html.P('Perfil dos testers alcançados durante a campanha', className='header-subtitle')
            ], className="header-text"),
            html.Div([
                html.Div([
                    html.Img(src='assets/png-transparent-person-icon-illustration-computer-icons-icon-design-symbol-person-symbol-miscellaneous-monochrome-sticker.png', className='header-icon'),  # Add icons
                    html.A('Recrutamento de Avaliadores', href='/recrutamento', className='header-link')
                ], className='header-link-container'),
                html.Div([
                    html.Img(src='assets/sensorial.png', className='header-icon'),  # Add icons
                    html.A('Análise Sensorial', href='/analise-sensorial', className='header-link')
                ], className='header-link-container')
            ], className='header-links')
        ], className="header"),
        ...
        html.Div([
            html.Div([
                html.P('Escolha a Base de Dados', className='label'),
                dcc.Dropdown(
                    id='base_de_dados',
                    options=[
                        {'label': 'Wafer', 'value': 'Wafer'},
                        {'label': 'Pipoca', 'value': 'Pipoca'}
                    ],
                    value="Wafer",
                    className='dropdown'
                )
        ...
        html.Div([
            ...
            html.Div([
                html.P('Segment', className='label'),
                dcc.Dropdown(id='Segment', options=se_declara_options, value="Todas as categorias", className='dropdown')
            ], className="dropdown-column"),
        ...
        html.Div([
            ...
            html.Div([
                dcc.Graph(id='g_h_bar_chart1_', config={'displayModeBar': 'hover'}, style={'height': '950px'})
            ], className='chart-container eight columns')
        ], className="row flex-display"),

        html.Div([
            html.Div([
                dcc.Graph(id='g_h_bar_chart2_', config={'displayModeBar': 'hover'}, style={'height': '950px'})
            ], className='chart-container eight columns')
        ], className="row flex-display")
