...
# Supondo que você já tenha um DataFrame chamado sales
...
app.layout = html.Div((
    ...
    html.Div([
        html.Div([
            html.H3('Recrutamento', style={'margin-bottom': '0px', 'color': 'white'}),
        ...
        html.Div([
            ...
            dcc.Dropdown(id='radio_items',
                         options=[{'label': i, 'value': i} for i in ['Consumer', 'Corporate', 'Home Office']],
                         value='Consumer',
                         className='dcc_compon'),
        ], className="one-third column", id='title3'),

        html.Div([
            html.P('Dropdown 1', className='fix_label', style={'color': 'white'}),
        ...
        html.Div([
            html.P('Dropdown 2', className='fix_label', style={'color': 'white'}),
        ...
        html.Div([
            html.P('Dropdown 3', className='fix_label', style={'color': 'white'}),
            dcc.Dropdown(id='dropdown3',
                         options=[{'label': f'Option {i}', 'value': f'option_{i}'} for i in range(1, 6)],
                         value='option_1',
                         className='dcc_compon'),
        ], className="one-third column", id='title6'),

        html.Div([
            html.P('Dropdown 4', className='fix_label', style={'color': 'white'}),
            dcc.Dropdown(id='dropdown4',
                         options=[{'label': f'Option {i}', 'value': f'option_{i}'} for i in range(1, 6)],
                         value='option_1',
                         className='dcc_compon'),
        ], className="one-third column", id='title7'),
